...
*/
-- CreateEnum
CREATE TYPE "OdoUnit" AS ENUM ('KILOMETERS', 'MILES');
...
-- CreateEnum
CREATE TYPE "BodyType" AS ENUM ('SEDAN', 'HATCHBACK', 'SUV', 'MPV', 'COUPE', 'CONVERTIBLE', 'ROADSTER');

-- CreateEnum
CREATE TYPE "Color" AS ENUM ('WHITE', 'BLACK', 'RED', 'BLUE', 'GREEN', 'YELLOW', 'ORANGE', 'PURPLE', 'PINK', 'BROWN', 'GRAY', 'SILVER', 'GOLD');

-- CreateEnum
CREATE TYPE "CustomerStatus" AS ENUM ('SUBSCRIBED', 'INTERESTED', 'CONTACTED', 'PURCHASED', 'COLD');
...
CREATE TABLE "classifieds" (
    ...
    "odoUnit" "OdoUnit" NOT NULL DEFAULT 'KILOMETERS',
...
-- CreateIndex
CREATE INDEX "idx_make_model" ON "classifieds"("make_id", "model_id");

-- CreateIndex
CREATE INDEX "idx_status" ON "classifieds"("status");

-- CreateIndex
CREATE INDEX "idx_price" ON "classifieds"("price");

-- CreateIndex
CREATE UNIQUE INDEX "customer_lifecycle_customer_id_key" ON "customer_lifecycle"("customer_id");
